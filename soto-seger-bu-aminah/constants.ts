...
export const MENU_ITEMS: MenuItem[] = [
  ...
  { id: 'sate-usus', name: 'Sate Ayam', description: 'Sate usus ayam gurih.', price: 'Rp 5.000', category: 'Tambahan Sate', image: encodeLib('WhatsApp Image 2026-02-13 at 18.35.47 (2).jpeg') },
