...
export const MENU_ITEMS: MenuItem[] = [
  ...
  { id: 'soda-gembira', name: 'Soda Gembira', description: 'Soda, susu, dan sirup.', price: 'Rp 14.000', category: 'Minuman', image: 'https://i.pinimg.com/736x/fd/e1/6f/fde16f156aaac0db132ebbfa749928a2.jpg' },
];
