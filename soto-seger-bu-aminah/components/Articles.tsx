...
import { PARTNERS, PARTNER_LOGOS, WHATSAPP_PARTNER_URL } from '../constants';
          ...
          <div className="flex flex-col lg:flex-row">
            ...
            <div className="lg:w-1/2 p-8 md:p-12 lg:p-16 flex flex-col justify-center relative z-10">
              ...
              <p className="text-emerald-100 text-lg mb-8 leading-relaxed">
                Kami membuka kesempatan bagi Anda untuk berkolaborasi. Baik sebagai mitra franchise, supplier bahan baku lokal, atau layanan katering untuk acara spesial Anda.
              </p>
              
              <div className="space-y-4 mb-10">
                {PARTNERS.map((partner) => (
                  <div key={partner.id} className="flex items-start gap-4 p-4 rounded-xl bg-white/5 border border-white/10 hover:bg-white/10 transition-colors">
                    <div className="w-10 h-10 rounded-full bg-emerald-500/20 flex items-center justify-center flex-shrink-0 text-emerald-300">
