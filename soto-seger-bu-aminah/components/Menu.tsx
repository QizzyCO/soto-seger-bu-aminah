                ...
                >
                  <div className="relative h-40 overflow-hidden">
                    ...
                    <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/60 to-transparent p-4 opacity-0 group-hover:opacity-100 transition-opacity">
                       <p className="text-white text-xs font-bold">Resep Autentik</p>
                    </div>
                  </div>
                  <div className="p-5 flex flex-col flex-grow">
                    <div className="flex justify-between items-start mb-2">
                      <h5 className="font-bold text-base text-amber-900 leading-tight group-hover:text-emerald-700 transition-colors">{item.name}</h5>
                    </div>
                    <p className="text-stone-500 text-xs mb-4 flex-grow line-clamp-2">{item.description}</p>
