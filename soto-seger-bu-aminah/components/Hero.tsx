...
import { HERO_BG, LOGO_URL, WHATSAPP_RESERVATION_URL } from '../constants';
      ...
      <div className="relative z-20 text-center px-4 max-w-4xl mx-auto">
        <div className="mb-8 flex flex-col items-center animate-fade-in-up">
          ...
          <h1 className="text-4xl md:text-7xl font-extrabold text-white mb-6 leading-tight drop-shadow-lg">
            Soto Seger, <br />
            <span className="text-amber-400">Rasa Legendaris</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <a 
              ...
              className="px-8 py-4 bg-emerald-600 hover:bg-emerald-700 text-white rounded-full font-bold text-lg transition-all transform hover:scale-105 shadow-xl w-full sm:w-auto text-center"
            >
              Pesan Sekarang
            </a>
            <a 
